...
export type AstNode = AstRoot | AstHeading | AstParagraph | AstText | AstWikilink | AstInlineCode | AstCodeBlock | AstLink | AstImage | AstMath | AstBlockquote | AstList | AstListItem | AstThematicBreak | AstStrong | AstEmphasis | AstTable | AstTableHead | AstTableRow | AstTableCell | AstStrikethrough | AstTaskListMarker | AstFootnoteDefinition | AstFootnoteReference | AstDefinitionList | AstDefinitionListTitle | AstDefinitionListDefinition | AstCloze | AstConceptRef | AstAdmonition;
